 ...
 * Example definition for two devices and bus 0 and address 0-1
 */
...
int main(int argc, char** argv) {
    ...
    devConfig.dev_addr = hbi_devices_info[deviceId].dev_addr;;
    devConfig.bus_num = hbi_devices_info[deviceId].bus_num;
