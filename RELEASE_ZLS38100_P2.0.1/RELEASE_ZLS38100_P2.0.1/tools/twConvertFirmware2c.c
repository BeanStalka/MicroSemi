...
*
* -o <output file name.h/.bin> - Converted output file name (.h or .bin)
*
...
void readCfgFile() 
{
    ...
    if (bOutputTypeC)
    {
        ...
        outLog("#ifndef __%s_H__\n",array_name);  
        outLog("#define __%s_H__\n\n",array_name); 
