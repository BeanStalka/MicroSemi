...
for firmware block size: 16*2^n, where n can be one of these values 0, 1, 2 or 3
for configuration block size: 1*2^n, where n can be one of these values 0, 1, 2, 3, 4, 5, 6 or 7
...
for ex. to compile on Linux platform  - use 
gcc twConverFirmware2.c -o  twConvertFirmware2c
...
twConvertFirmware2c.exe i zl38040_config.cr -o zl38040_config.bin -b 16 -f zl38040
