...
//#define ZL380TW0
#ifdef ZL380TW0_CODEC_DRIVER
static struct snd_soc_dai_link ambevk_dai_link = {
	.name = "zl380tw0",
	.stream_name = "zl380tw0-STREAM",
	.codec_dai_name = "zl380tw0-hifi",
...
static const struct of_device_id ambevk_dt_ids[] = {
	{ .compatible = "ambarella,s2lmkiwi-zl380tw0", },
	{ /* sentinel */ }
};
#endif
...
MODULE_DESCRIPTION("Ambarella S2L with Zl380xx Codec for ALSA");
MODULE_LICENSE("GPL");
MODULE_ALIAS("snd-soc-zl380xx");
